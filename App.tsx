    ...
    <div className="min-h-screen bg-black">
      ...
      <nav className="fixed top-0 w-full bg-black/95 backdrop-blur-lg z-50 border-b border-white/10 py-3 px-4 md:px-6 flex justify-between items-center">
        ...
        <button 
          ...
          className="bg-elite-red hover:bg-white hover:text-black text-white px-4 md:px-8 py-2.5 md:py-3.5 rounded-sm font-black text-[12px] md:text-[18px] uppercase tracking-normal md:tracking-widest transition-all shadow-lg whitespace-nowrap"
        >
      ...
      <main className="pt-[58px] md:pt-[65px]">
        ...
        <section id="benefits" className="py-6 md:py-12 bg-white relative border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-6 md:mb-8 max-w-3xl mx-auto">
              <h2 className="text-[12px] md:text-[17px] font-black text-elite-red uppercase tracking-[0.6em] mb-1">{benefitsSection.badge}</h2>
              <h3 className="text-2xl md:text-5xl lg:text-6xl font-black text-black tracking-tighter uppercase leading-tight lg:leading-[1.3] text-balance">{benefitsSection.title}</h3>
        ...
        <section className="py-6 md:py-12 bg-black text-center relative overflow-hidden border-b border-white/5">
            ...
            <div className="max-w-5xl mx-auto px-6">
                <h2 className="text-elite-red font-medium text-[12px] md:text-[17px] uppercase tracking-[0.5em] md:tracking-[0.6em] mb-2 md:mb-4">{opportunitySection.badge}</h2>
                <h3 className="text-2xl md:text-5xl font-black mb-4 md:mb-6 tracking-tighter text-white leading-tight lg:leading-[1.3] uppercase text-balance">
                    {opportunitySection.title}
                </h3>
                <div className="max-w-4xl mx-auto">
                    <p className="text-base md:text-xl text-white font-medium leading-snug md:leading-tight mb-4 md:mb-6 uppercase tracking-tighter text-balance">
                    ...
                    <p className="text-white text-[15px] md:text-[19px] font-bold mb-4 md:mb-6 uppercase tracking-tight">
                        {opportunitySection.partnerLabel}
                    </p>

                    <div className="relative overflow-hidden fade-edge pt-2 md:pt-4 pb-0">
                      <div className="flex md:grid md:grid-cols-4 gap-6 md:gap-12 items-center justify-start md:justify-center animate-stats-marquee md:animate-marquee-slow md:animate-none whitespace-nowrap">
                          {displayPartners.map((partner, idx) => (
                            ...
                            >
                                ...
                                <span className={`text-white font-black text-[7px] md:text-[11px] uppercase tracking-[0.1em] md:tracking-widest border-t ${partner.border} pt-1 md:pt-2 px-1 md:px-4 whitespace-nowrap opacity-80 group-hover:opacity-100`}>
                                  {partner.name}
                                </span>
                            </div>
                          ))}
                ...
                <div className="mt-8 md:mt-10 px-6 flex flex-col items-center relative z-10">
                    <button 
                        onClick={() => setShowForm(true)}
                        className="w-full md:w-auto bg-elite-red hover:bg-white hover:text-black text-white px-6 md:px-12 py-4 md:py-5 rounded-sm font-black text-[13px] sm:text-[15px] md:text-lg uppercase tracking-wide md:tracking-widest transition-all shadow-[0_15px_40px_rgba(220,38,38,0.4)] mb-3 flex items-center justify-center text-center whitespace-nowrap mx-auto"
                    >
        ...
        <section id="faq" className="py-8 md:py-16 bg-white text-black">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-6 md:mb-10">
              <h2 className="text-[12px] md:text-[17px] font-bold text-elite-red uppercase tracking-[0.6em] mb-1">{faqSection.badge}</h2>
              <h3 className="text-2xl md:text-5xl font-black tracking-tighter uppercase leading-tight lg:leading-[1.3]">{faqSection.title}</h3>
            </div>
            <FAQ />
          </div>
        </section>
