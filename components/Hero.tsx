...
const Hero: React.FC<HeroProps> = ({ onApplyClick }) => {
  ...
  // Hàm hỗ trợ đổi màu đỏ cho các cụm từ cụ thể
  ...
  return (
    <div className="relative bg-black pt-2 md:pt-4 pb-12 lg:pt-6 lg:pb-20 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col space-y-5 md:space-y-7 w-full items-center lg:items-start">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
            <div className="lg:col-span-5 space-y-5">
              <div className="max-w-xl bg-gradient-to-r from-white/10 to-transparent p-4 md:p-6 rounded-r-lg border-l-[1px] border-white text-left">
                <h3 className="text-[15px] md:text-[21px] text-white font-black tracking-tight mb-2 md:mb-3 leading-tight lg:leading-[1.3] uppercase italic text-balance">
                  {highlightImportantText(hero.headline)}
                </h3>
                <p className="text-[14px] md:text-[19px] leading-snug md:leading-relaxed font-medium italic tracking-tight text-white">
              ...
              <div className="flex flex-col space-y-4">
                <button
                  ...
                  className="group relative w-full md:w-fit overflow-hidden bg-elite-red text-white px-12 py-5 rounded-sm font-black text-lg uppercase tracking-widest transition-all shadow-[0_20px_50px_rgba(220,38,38,0.3)] hover:scale-105 italic"
                >
                ...
                <div className="flex items-center gap-4 justify-center lg:justify-start">
                  ...
                  <p className="text-white text-[12px] md:text-[14px] font-bold uppercase tracking-tight text-left leading-tight">
                    {hero.noteText}
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-7 w-full h-full">
              ...
              >
                {!playVideo ? (
                  <>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <div className="relative">
                          ...
                          <div className="relative w-20 h-20 md:w-24 md:h-24 bg-elite-red rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-500">
                            <div className="w-0 h-0 border-t-[12px] md:border-t-[15px] border-t-transparent border-l-[20px] md:border-l-[25px] border-l-white border-b-[12px] md:border-b-[15px] border-b-transparent ml-2"></div>
                          </div>
                      </div>
                    </div>
                  </>
                  ...
                  <iframe
                    src={`https://www.youtube-nocookie.com/embed/${hero.videoId}?autoplay=1&rel=0&modestbranding=1&showinfo=0`}
